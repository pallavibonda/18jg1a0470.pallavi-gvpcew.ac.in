This project is aimed to design a system to control the electrical devices in
industries or homes by using GSM technology.
...
modem that works with a GSM wireless network. This GSM Modem can accept any GSM
network operator SIM card and act just like a mobile phone with its own unique phone number.
...
directly or to any microcontroller.
 This project gives the best solution for electrical power wastage. Also the manual
operation is completely eliminated. This project is implemented on wireless technology. One of
wireless communication system is GSM as it is very cheap and very easy to implement.
...
devices in accordance with the received password. If the password entered is wrong, the system
alerts the buzzer immediately. This method of operating the appliances helps in providing
security to the devices and also power is saved up to some extent. A buzzer will be interfaced to
the controller for providing warning sounds. A 16X2 LCD will be interfaced to the controller to
display the status of the loads.
 This project uses regulated 5V, 500mA power supply. Unregulated 12V DC is used
for relay. 7805 three terminal voltage regulator is used for voltage regulation. Bridge type full
